...
<body class="bg-slate-200">
    ...
    <div class="bg-blue-500 text-white font-bold text-4xl py-10">
    ...
    <div class="mt-4 bg-white rounded-xl p-4 container mx-auto">
        <div class="text-2xl font-semibold mb-3">KODE AKSI PELANGGARAN : {{ $kode_aksi }}</div>
        @if ($aksi == null)
        ...
        @else
            ...
            <div class="mb-4">
                ...
                <button type="submit"
                    class="text-white mb-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center ">Tambah Pelanggaran</button>
            </form>
            ...
            <form action="{{ route('pelanggaran.print') }}" method="POST">
                ...
                <button type="submit"
                class="text-white mb-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center ">Cetak</button>
            </form>
